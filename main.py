...
def parse_args():
    ...
    parser.add_argument('--entity_dim', type=int, default=16, help='dimension of entity and relation embeddings')
    parser.add_argument('--pro_dim', type=int, default=64, help='dimension of projection embeddings')
    parser.add_argument('--word_dim', type=int, default=64, help='dimension of word embeddings')
    parser.add_argument('--hidden_dim', type=int, default=16, help='dimension of hidden state of LSTM')
    parser.add_argument('--n_hop', type=int, default=3, help='maximum hops')
    parser.add_argument('--lr', type=float, default=0.01, help='learning rate')
    parser.add_argument('--ls1_weight', type=float, default=5, help='weight of the ls1')
    parser.add_argument('--ls2_weight', type=float, default=2, help='weight of the ls2')
    ...
    parser.add_argument('--n_memory', type=int, default=30, help='size of ripple set for each hop')
    ...
    parser.add_argument('--re_get_ripple_set', type=bool, default=False, help='whether to re get ripple set')
